...
#define SEG_GPU_DVFS_FREQ1			(1050000)	/* KHz */
#define SEG_GPU_DVFS_FREQ2			(1000000)	/* KHz */
#define SEG_GPU_DVFS_FREQ3			(950000)	/* KHz */
#define SEG_GPU_DVFS_FREQ4			(920000)	/* KHz */
...
#define SEG_GPU_DVFS_VOLT0		(97000)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT1		(94000)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT2		(91000)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT3		(88000)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT4		(86000)		/* mV x 100 */
